...
<div className="card-group"><br /><br /><br />
  ...
  <path d="M8 13.5a5.5 5.5 0 1 1 0-11 5.5 5.5 0 0 1 0 11m0 .5A6 6 0 1 0 8 2a6 6 0 0 0 0 12"/>
    ...
    <div className="card-body">
      <h5 className="card-title">Mopnthly Produduct Sale</h5>
  ...
  <path fillRule="evenodd" d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0m-.646 5.354a.5.5 0 0 0-.708-.708L7.5 10.793 6.354 9.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z"/>
      ...
      <h5 className="card-title">Customer active in our site</h5>
      <p className="card-text"></p>
    </div>
    <div className="card-footer">
      <small className="text-muted"></small>
 ...
 <div className="card">
 <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-wallet2" viewBox="0 0 16 16">
  <path d="M12.136.326A1.5 1.5 0 0 1 14 1.78V3h.5A1.5 1.5 0 0 1 16 4.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 13.5v-9a1.5 1.5 0 0 1 1.432-1.499zM5.562 3H13V1.78a.5.5 0 0 0-.621-.484zM1.5 4a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5z"/>
</svg>   <div className="card-body">
     <h5 className="card-title">Anual gross sale in our site</h5>
     <p className="card-text"></p>
   </div>
   <div className="card-footer">
     <small className="text-muted"></small>
...
<div className="col">
  <div className="card h-100">
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-inboxes-fill" viewBox="0 0 16 16">
...
<div className="col">
  <div className="card h-100">
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-file-earmark-lock" viewBox="0 0 16 16">
